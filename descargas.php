...
if(count($files)){
	...
	$cont = count($files);
	echo "Hay ".$cont. " presupuesto(s) realizado(s).<br>";
	?>
	...
	//	echo date ("d-m-Y H:i:s.", filemtime($files[$i])) . (basename($files[$i])." <a href='".$files[$i]."'><img src='./imagenes/descarga.jpeg' style='max-width: 30px; max-height: 30px'/></a> | <a href='./eliminarpresupuesto.php?archivo=".$files[$i]."'><img src='./imagenes/delete.png' style='max-width: 30px; max-height: 30px'/></a><br>");


		echo date ("d-m-Y H:i:s.", filemtime($files[$i])) . (basename($files[$i])." <a href='".$files[$i]."'><img src='./imagenes/descarga.jpeg' style='max-width: 30px; max-height: 30px'/></a> | <a href='./eliminarpresupuesto.php?archivo=".$files[$i]."'><img src='./imagenes/delete.png' style='max-width: 30px; max-height: 30px'/></a> | <input type='checkbox' name='casilla[]' value='".$files[$i]."'><br>");
