...
$ReadSql = "SELECT * FROM `productos` ORDER BY productoNombre ASC LIMIT $start, $perpage";
    ...
    <div class="container">
        ...
        <div class="table-wrapper">
						...
						<td>
							<span class="custom-checkbox">
								...
								<?php	
										...
										echo "<td>". $fila[productoNombre] . "</td>";
                        		echo "<td>". $fila[productoPrecio] . "</td>";
                        ?>      
                                ...
                                <form name="modifica" method="post" action="./modifica.php">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <?php echo "<textarea name='articulo' class='form-control' required>".$fila[productoNombre]."</textarea>"; ?>
                                                </div>
                                                <div class="form-group">
                                                        <label>Precio</label>
                                                        <?php echo "<input type='text' name='precio' value='".$fila[prodcutoPrecio]."' class='form-control' required> ";?>
                                                </div>
			...
			<div class="clearfix">
                ...
                <div class="hint-text">Mostrando <b>10</b> de <b><?php echo "$totalres"; ?></b> entradas</div>
                <ul class="pagination">
                	<!--
