...
<body>
    ...
    <div class="container">
		...
		<li>
          ...
          <ul class="dropdown">
            ...
            <li><a href="./listado.php">Articulos</a></li>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Listado <b>presupuestos.</b></h2>
					</div>
					<div class="col-sm-6">
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
                  ...
                  <tr>
						<td>
							<span class="custom-checkbox">
								<?php echo "<input type='checkbox' id='checkbox".$files[$i]."' name='options[]' value='".$files[$i]."'>" ?>
								<?php echo "<label for='checkbox1".$files[$i]."'></label>" ?>
							</span>					
								...
								<?php	
										...
										//echo "<td>". $fila[1] . "</td>";
										echo "<td>".date ("d-m-Y H:i:s.", filemtime($files[$i]))."</td>";
										echo "<td>".(basename($files[$i])." <a href='".$folder.$files[$i]."'></a><br>")."</td>";
                        		//echo "<td>". $fila[2] . "</td>";
                        ?>      
                        ...
                        <td>
                           ...
                           <?php echo "<a href='".$files[$i]."' class='edit' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Abrir'>&#xe022;</i></a>"; ?>
                          ...
                          <!-- como yo supongo que deberia se en php segun como veo arriba -->
                           <?php echo "<a href='./eliminarpresupuesto.php?archivo=".$files[$i]."' class='delete' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Eliminar'>&#xE872;</i></a>"; ?>
                        </td>
                    </tr>
	...
	<div id="deleteEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="eliminar" method="post" action="./eliminarmultiple.php">
            ...
            <input type="hidden" id="delid" name="delid" value="">
						...
						<h4 class="modal-title">Eliminar presupuestos</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">	
										
						<p>Seguro desea eliminar los presupuestos seleccionados?</p>
